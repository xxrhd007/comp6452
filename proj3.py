...
spark = SparkSession.builder.master("local[2]").appName("project3").getOrCreate()
...
#convert headline into int,join broadcasted frequncy word into vset
int_words2 = word_list.join(broadcast(int_words), int_words.word == word_list.w,"inner").select("id","v","years")
